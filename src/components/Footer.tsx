      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-white/95 p-2 rounded-lg shadow-sm shrink-0 flex items-center justify-center">
                <Image src="/images/logo-1.png" alt="Berkas Hukum Logo" width={48} height={48} className="h-12 w-auto object-contain" />
              </div>
              <div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-400">+62 812-9639-3972, +62 857-7112-3000</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-400">support@berkashukum.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-xs text-center md:text-left">
            &copy; {currentYear} Berkas Hukum Corporate. All rights reserved.
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-xs text-gray-500">
            <Link href="/kebijakan-privasi" target="_blank" className="hover:text-gold transition-colors">Kebijakan Privasi</Link>
            <Link href="/syarat-ketentuan" target="_blank" className="hover:text-gold transition-colors">Syarat & Ketentuan</Link>
            <Link href="/developer" target="_blank" className="hover:text-gold transition-colors">luckmen.org</Link>
          </div>
        </div>
      </div>
    </footer>
