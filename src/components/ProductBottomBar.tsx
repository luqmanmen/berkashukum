        ...
        <div className="flex items-center justify-center gap-4 pt-4 pb-6 px-4 md:px-8">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center w-12 h-12 rounded-xl transition-all shrink-0 ${
              added ? "text-green-600 bg-green-50" : "text-[#c9a84c] hover:bg-amber-50"
            }`}
            title="Keranjang"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            ...
            className="w-full max-w-[240px] bg-[#c9a84c] hover:bg-[#b8963e] text-white font-bold text-sm py-3.5 rounded-xl flex items-center justify-center gap-2 transition-colors"
          >
