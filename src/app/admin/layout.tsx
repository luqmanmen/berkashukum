...
export default async function AdminLayout({
  ...
  const allNavItems = [
    ...
    { href: "/admin/lawyer", label: "Lawyer", icon: "⚖️", superOnly: true },
    { href: "/admin/jadwal-konsultasi", label: "Jadwal Konsultasi", icon: "📅", superOnly: false },
    { href: "/admin/layanan", label: "Layanan", icon: "💎", superOnly: true },
