  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 font-serif">Kelola Produk</h1>
          <p className="text-gray-500 text-sm mt-1">Daftar semua produk digital dan layanan konsultasi</p>
        </div>
        <Link
