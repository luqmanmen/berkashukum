          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Solusi Hukum Tepat untuk Masalah <span className="text-gold">Kompleks</span>.
              </h1>
              <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
                Dr. Satria Wibowo, S.H., M.H., Ph.D. mendedikasikan lebih dari 15 tahun keahlian di bidang kepailitan, hukum bisnis, dan perlindungan aset perusahaan.
              </p>
            ...
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                ...
                <div className="absolute inset-0 bg-navy-mid rounded-full overflow-hidden border-4 border-navy-dark shadow-2xl flex items-end justify-center">
                  ...
                  {/* Note: Jika ada foto asli, gunakan Image next.js di sini */}
                </div>
              </div>
            </div>
